...
class EdgeDevice():
    ...
    def __init__(self,opcuaServer,modbusClient,opcuaObjects,noEntriesInitialized):
        ...
        self.opcuaObjects = opcuaObjects
        self.noEntriesInitialized = noEntriesInitialized
    ...
    def initializeFromLegacy(self):
        ...
        for i in range(0, self.noEntriesInitialized):
            ...
            if registerString != '-':
                ...
                atv72object: Node = self.opcuaObjects.add_object(0, self.df.at[i, 'Name'], ATV72TYPE)
        ...
        for i in range(0, self.noEntriesInitialized):
            ...
            if registerString != '-':
                ...
                if value != self.registerValues[registerAddress]:
                    ...
                    atv72object = self.opcuaObjects.get_child(self.df.at[i, 'Name'])
                    ...
                    self.opcuaServer.export_xml([valueNode], "opcuanodes.xml")
